...
TCP/IP 从上到下依次是 应用层 -> 传输层 -> 网络层 -> 链路层
...
![IP 首部](/images/IP-header.png)

![TCP 首部](/images/TCP-header.png)
...
![TCP 建立连接](/images/tcp-establish-connection.jpg)
...
![TCP 断开连接](/images/tcp-release-connection.jpg)
