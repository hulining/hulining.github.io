...
![四表五链](linux-firewall-and-iptables/firewalld-tables-and-chains.png)
...
![数据包流向](linux-firewall-and-iptables/packet-flow.svg)

![数据包流向](linux-firewall-and-iptables/packet-flow.png)
